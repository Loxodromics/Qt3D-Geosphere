...
void GeosphereGeometry::fillBuffers()
{
	...
	const auto vertices = QVector<QVector3D>()
							<< v0 << v0.normalized()  << v1 << v1.normalized()  << v2 << v2.normalized()  << v3 << v3.normalized()  << v4 << v4.normalized()  << v5 << v5.normalized()  << v6 << v6.normalized()  << v7 << v7.normalized()  << v8 << v8.normalized()  << v9 << v9.normalized()  << v10 << v10.normalized()  << v11 << v11.normalized();
